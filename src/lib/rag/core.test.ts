...
const products: CatalogProduct[] = [
  {
    ...
    images: [],
    variants: [
      { id: "gris", externalCode: null, label: "Gris", price: 2099, compareAtPrice: null, availability: "available", active: true, sortOrder: 1 },
      { id: "azul-inactivo", externalCode: null, label: "Azul", price: 2099, compareAtPrice: null, availability: "available", active: false, sortOrder: 2 },
    ],
  },
  {
    id: "hidden",
