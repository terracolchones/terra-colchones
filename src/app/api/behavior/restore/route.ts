...
import { restoreBehaviorVersion } from "@/lib/behavior/store";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    assertBehaviorShape(input, ["versionId", "expectedRevision"]);
    return NextResponse.json(
      restoreBehaviorVersion(behaviorRevision(input.versionId), behaviorRevision(input.expectedRevision)),
